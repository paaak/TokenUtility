...
#[derive(Debug)]
pub struct TokenUtilityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenUtilityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenUtility processing");
    
    let mut processor = TokenUtilityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenUtilityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenUtilityProcessor::new(false);
